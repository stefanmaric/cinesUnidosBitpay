((function () {
    ...
    a = function (a, b, c, d) {
        ...
        return d = "https://coinbase.com", f = function (a) {
            ...
            if (e === "hide modal") return a("#coinbase_modal_iframe_" + c).hide();
